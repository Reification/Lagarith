 ...
 *
 ***************************************************************************/
LRESULT PASCAL DriverProc(DWORD_PTR dwDriverID, HDRVR hDriver, UINT uiMessage, LPARAM lParam1,
                          LPARAM lParam2) {
	CodecInst* pi = (CodecInst*)dwDriverID;
	switch (uiMessage) {
	case DRV_LOAD: return (LRESULT)1L;

	case DRV_FREE: return (LRESULT)1L;

	case DRV_OPEN: return (LRESULT)Open((ICOPEN*)lParam2);
    ...
    *********************************************************************/
	...
	case ICM_ABOUT: return ICERR_UNSUPPORTED;
    ...
    *********************************************************************/
	...
	case DRV_INSTALL:
	case DRV_REMOVE: return (LRESULT)DRV_OK;
	}
